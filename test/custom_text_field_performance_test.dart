...
void main() {
  group('CustomTextField Performance Tests', () {
    ...
    testWidgets('focus change performance test', (WidgetTester tester) async {
      ...
      stopwatch.stop();
      print('Focus change time: ${stopwatch.elapsedMicroseconds} microseconds');
    ...
    testWidgets('text input performance test', (WidgetTester tester) async {
      ...
      stopwatch.stop();
      print('Text input time: ${stopwatch.elapsedMicroseconds} microseconds');
      
      // Assert that text input is under reasonable threshold (100ms)
      expect(stopwatch.elapsedMicroseconds, lessThan(100000));
    });

    testWidgets('multiple text fields build performance', (WidgetTester tester) async {
      final stopwatch = Stopwatch()..start();
      ...
      stopwatch.stop();
      print('10 CustomTextFields build time: ${stopwatch.elapsedMicroseconds} microseconds');
    ...
    testWidgets('rapid focus changes performance', (WidgetTester tester) async {
      ...
      stopwatch.stop();
      print('Rapid focus changes time: ${stopwatch.elapsedMicroseconds} microseconds');
    ...
    testWidgets('memory usage during text input', (WidgetTester tester) async {
      ...
      stopwatch.stop();
      print('Large text input time: ${stopwatch.elapsedMicroseconds} microseconds');
    ...
    testWidgets('rebuild performance on state changes', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          theme: FliggleThemeData.lightTheme,
          home: const Scaffold(
      ...
      stopwatch.stop();
      print('Multiple rebuilds time: ${stopwatch.elapsedMicroseconds} microseconds');
    ...
    testWidgets('performance baseline comparison', (WidgetTester tester) async {
      ...
      print('Standard TextField build time: ${standardStopwatch.elapsedMicroseconds} microseconds');
      ...
      print('CustomTextField build time: ${customStopwatch.elapsedMicroseconds} microseconds');
      
      // CustomTextField should not be significantly slower than standard TextField
      final performanceRatio = customStopwatch.elapsedMicroseconds / standardStopwatch.elapsedMicroseconds;
      print('Performance ratio (Custom/Standard): ${performanceRatio.toStringAsFixed(2)}');
      
      // CustomTextField should be within 5x the performance of standard TextField
      expect(performanceRatio, lessThan(5.0), 
             reason: 'CustomTextField should not be more than 5x slower than standard TextField');
    });
  });
}
