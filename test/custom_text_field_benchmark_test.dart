...
class PerformanceBenchmark {
  ...
  void printStatistics() {
    ...
    print('=== $name Performance Statistics ===');
    print('Min: ${min}μs');
    print('Max: ${max}μs');
    print('Average: ${avg.toStringAsFixed(2)}μs');
    print('Median: ${median}μs');
    print('Samples: ${measurements.length}');
    print('');
  }
}
...
void main() {
  group('CustomTextField Benchmark Tests', () {
    testWidgets('comprehensive performance benchmark', (WidgetTester tester) async {
      ...
      final buildAvg = buildBenchmark.measurements.reduce((a, b) => a + b) / buildBenchmark.measurements.length;
    ...
    testWidgets('stress test with many text fields', (WidgetTester tester) async {
      ...
      for (int fieldCount in [5, 10, 20, 50]) {
        ...
        print('Building $fieldCount CustomTextFields: ${stopwatch.elapsedMicroseconds}μs');
        ...
        print('Scrolling $fieldCount CustomTextFields: ${scrollStopwatch.elapsedMicroseconds}μs');
      }
      
      // Verify that build time grows reasonably with field count
      // Build time should not grow exponentially
      expect(buildTimes.last / buildTimes.first, lessThan(10), 
    ...
    testWidgets('memory efficiency test', (WidgetTester tester) async {
      ...
      for (int cycle = 0; cycle < 10; cycle++) {
        ...
        print('Completed memory cycle $cycle');
      }
      
      // If we reach here without memory issues, the test passes
      expect(true, isTrue, reason: 'Memory efficiency test completed successfully');
    });
    ...
    testWidgets('animation performance test', (WidgetTester tester) async {
      ...
      print('Focus animation completion time: ${animationStopwatch.elapsedMicroseconds}μs');
